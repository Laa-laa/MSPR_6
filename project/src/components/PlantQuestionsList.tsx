...
export default function PlantQuestionsList() {
    ...
    const [selectedQuestion, setSelectedQuestion] = useState<{ Id: number; Title: string, Content: string, DateSent: string } | null>(null);
    ...
    const openModal = (question: { Id: number; Title: string, Content: string, DateSent: string }) => {
