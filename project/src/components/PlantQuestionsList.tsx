        ...
        <div className="container p-4"> 
            ...
            <div className="card flex flex-col justify-center">
                {questions.map((question) => (
                    <Card key={question.Id} className="md:w-25rem mb-4" style={{ borderRadius: '15px', maxHeight: '100%', boxShadow: '0 4px 6px rgba(0, 0, 0, 0.1)', overflow: 'hidden'  }}>
                        <div className="flex">
                            ...
                            <div className="w-2/3 flex flex-col justify-between flex-grow p-2 justify-between bg-customGreen" style={{ borderRadius: '0 15px 15px 0' }}>
                                ...
                                <p className='text-white'>{question.Content.slice(0, 60)}{question.Content.length > 60 ? '...' : ''}</p>
